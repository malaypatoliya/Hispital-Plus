...
const AddBloodBank = () => {
    ...
    const addBloodBankHandler = async () => {

        if(!name || !address || !area || !city || !contact_no || !location || !AP || !AN || !BP || !BN || !ABP || !ABN || !OP || !ON ){
            setErrorMsg(true);
            return false; // stop execution
        }
        // console.log(name, address, area, city, contact_no, location, AP, AN, BP, BN, ABP, ABN, OP, ON);

        let result = await fetch('http://localhost:5000/add-blood-bank', {
            method: 'POST',
                ...
                <div className="row">
                    ...
                    <div className="ContentDiv">
                        ...
                        <div className="formWidth">
                            <h3 className="headingTitle">ADD NEW BLOOD BANK</h3>
                            ...
                            <button className="btn btn-primary" onClick={addBloodBankHandler} type="button">Add</button>
                        </div>

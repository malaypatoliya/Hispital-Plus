...
const AddProduct = () => {
    ...
    const addDoctorHandler = async () => {
        ...
        // console.log(name, address, area, city, contact_no, specialization, experience, degree, clinic_name, opening_time, closing_time, location, icu_aval, bed_aval);

        let result = await fetch('http://localhost:5000/add-doctor', {
            method: 'POST',
            body: JSON.stringify({ name, address, area, city, contact_no, specialization, experience, degree, clinic_name, opening_time, closing_time, location, icu_aval, bed_aval }),
            headers: {
                ...
                <div className="row">
                    ...
                    <div className="ContentDiv">
                        ...
                        <div className="formWidth">
                            <h3 className="headingTitle">ADD NEW DOCTOR</h3>
                            ...
                            <button className="btn btn-primary" onClick={addDoctorHandler} type="button">Add</button>
                        </div>
